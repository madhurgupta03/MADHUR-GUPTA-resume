...
\geometry{left=1cm, top=.8cm, right=1cm, bottom=.5cm, footskip=.5cm}
...
\mobile{+91-9452730775}
\email{madhur.jhansi@gmail.com}

%\homepage{www.posquit0.com} 
\github{github.com/madhurgupta03}
\linkedin{linkedin.com/in/madhurgupta03}
% \gitlab{gitlab-id}
